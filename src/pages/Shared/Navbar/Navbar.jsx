...
const Navbar = () => {
    ...
    const navLinks = <>
        <NavLink to="/" className={({ isActive, isPending }) =>
            isPending ? "pending" : isActive ? "text-lg text-[#2eca7f] font-bold mr-4" : "text-xl font-semibold mr-4"
        }
        > Home</NavLink>
        <NavLink to="/createShop" className={({ isActive, isPending }) =>
            isPending ? "pending" : isActive ? "text-lg text-[#2eca7f] font-bold mr-4" : "text-lg font-semibold mr-4"
        }
        > Create Shop</NavLink>
