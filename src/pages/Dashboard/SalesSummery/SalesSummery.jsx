...
const SalesSummery = () => {
    ...
    const totalSalesProduct = sales?.result?.reduce((total, item) => total + item.sellingPrice, 0)
    const totalInvest = sales?.result?.reduce((total, item) => total + item.productionCost, 0)
